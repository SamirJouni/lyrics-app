...
export class Provider extends Component {
	...
	componentDidMount () {
		fetch(`https://cors-proxy.htmldriven.com/?url=http://api.musixmatch.com/ws/1.1/chart.tracks.get?page=1&page_size=10&country=de&f_has_lyrics=1&apikey=${process.env.REACT_APP_MM_KEY}`)
